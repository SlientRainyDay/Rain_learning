...
- 23-24周：和朋友聚了一下，摆了两周![004645BF](https://cdn.jsdelivr.net/gh/SlientRainyDay/image@main/image/202402061229968.png)
...
> 主要任务：完成天问之路STL的学习，读完《STL源码剖析》，恶意程序分析的学习进行(50％)。
...
- 毕设之余抽空粗读了一下qemu1.x版本的源码
- 3个比较水的cve编号(实在太水了这里就不好意贴编号了，捂脸.jpg)
- 其他大部分时间就是上课、认真写作业以及打羽毛球了，下周开始恢复跑步。

## 第33周（2024.3.18—2024.3.24）

> 主要任务：清华实习—论文阅读，接着完成一个月之前的恶意程序的分析学习。
