...
- [ ] 加入w&m
- [ ] 写一个效果不错的fuzzer
- [ ] 学会go语言，并独立开发自己的博客，参考[Markdown-Blog](https://github.com/gaowei-space/markdown-blog)(开发成jekyll样式，便于直接适配github.io)
- [ ] 打三次线下比赛(能拿奖最好啦)
...
> 目前上半年的初步目标是 天问之路 & re复健 & 学pwn & 学go语言并进行博客的开发 → 学完sakura师傅的fuzzer课程 → 继续审路由器 → 写一个成品fuzzer出来。同时同步进行毕设(时间吞噬者，悲)和大创工作，尽量在4月份之前把这些工作结束吧。然后开始仔仔细细学数一了，考研越来越考察对概念理解的掌握了，只会做题型只能像去年一样惨败。
